...
import com.capg.mms.service.CityServiceImpl;
...
public class TheaterController {
	...
	public ResponseEntity<Response> createTheater( @RequestBody Theater theater) {
	...
	public ResponseEntity<Theater> updatetheater(@PathVariable(value = "ID") long ID, @RequestBody Theater t) {
